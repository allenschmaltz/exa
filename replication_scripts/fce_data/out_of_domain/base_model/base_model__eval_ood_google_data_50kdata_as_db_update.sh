...
DISTANCE_DEV_DIR="${SERVER_SCRATCH_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/fce_cnn_interp/${EXPERIMENT_LABEL}/exemplar/${SPLIT_NAME}_dist_dir/google2k_with50kdb"
# the database data structure is the same as above in this case
...
OUTPUT_DIR="${SERVER_SCRATCH_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/fce_cnn_interp/${EXPERIMENT_LABEL}/out/exemplar/eval/revision_experiments/linearexa_tanh_nearest_options_learned/standard_fcetrain_with50kaugmented_db"
OUTPUT_LOG_DIR="${OUTPUT_DIR}"/logs
...
--output_annotations_file "${OUTPUT_DIR}"/${ADD_EXPERIMENT_ID}.linear_exa.epoch${EPOCH}.database_${DATABASE_SPLIT_NAME}.query_${SPLIT_NAME}.${EXA_MODEL_SUFFIX}.eval.analysis_file.annotations.r1.txt \
--save_annotations \
...
# GENERATED:
#         Precision: 0.5638783269961977
#         Recall: 0.2352101506740682
#         F1: 0.33195299384443205
#         F0.5: 0.4407132243684992
#         MCC: 0.3365123372410452
...
#         Recall: 0.1850911974623315
#         F1: 0.29766611401606935
#         F0.5: 0.46871234637320264
#         MCC: 0.35661573237644945
...
# DETECTION OFFSET: 0.0
# GENERATED:
#         Precision: 0.4364084191670399
#         Recall: 0.3091197462331483
#         F1: 0.3618976882369325
#         F0.5: 0.40320244941867683
#         MCC: 0.32914454142589933
