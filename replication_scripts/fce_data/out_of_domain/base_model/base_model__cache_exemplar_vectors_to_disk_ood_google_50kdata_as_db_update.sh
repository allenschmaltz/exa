################################################################################
#### uniCNN+BERT; cache exemplar distances to disk
...
################################################################################
#### uniCNN+BERT; generate exemplar data
...
#### training set augmented with 50k already correct sentences. The output
...
OUTPUT_DIR="${SERVER_SCRATCH_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/fce_cnn_interp/${EXPERIMENT_LABEL}/out/exemplar/fcetrain_with_google${ADD_DATA_SIZE}"
...
OUTPUT_DIR="${SERVER_SCRATCH_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/fce_cnn_interp/${EXPERIMENT_LABEL}/out/exemplar/fce_with_google"
OUTPUT_LOG_DIR="${OUTPUT_DIR}"/logs
...
#### With --top_k 25, ${DISTANCE_DEV_DIR} will be around 164mb.
################################################################################
...
OUTPUT_DIR="${SERVER_SCRATCH_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/fce_cnn_interp/${EXPERIMENT_LABEL}/out/exemplar/eval/revision_experiments/linearexa/standard_fcetrain_with50kaugmented_db"
OUTPUT_LOG_DIR="${OUTPUT_DIR}"/logs
