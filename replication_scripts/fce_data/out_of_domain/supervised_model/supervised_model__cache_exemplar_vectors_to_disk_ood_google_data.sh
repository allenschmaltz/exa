...
################################################################################
#### fully supervised: uniCNN+BERT+S*; generate exemplar data  -- save exemplar distance structures
...
#### file is created in the supervised_model__cache_exemplar_vectors_to_disk_ood_google_data_50kdata_as_db_update.sh
#### script.
################################################################################
...
EXEMPLAR_ORIGINGAL_DIR="${SERVER_DRIVE_PATH_PREFIX}/output/zero_shot_labeling/debug_cnn_finetune/${EXPERIMENT_LABEL}_ftype${FORWARD_TYPE}/exemplar"
# note that we've changed to the SERVER_SCRATCH_DRIVE_PATH_PREFIX for the new archive created in supervised_model__cache_exemplar_vectors_to_disk_ood_google_data_50kdata_as_db_update.sh for the test+2k
